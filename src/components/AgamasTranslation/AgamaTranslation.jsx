...
export default function AgamasTranslationsPage() {
  return (
    <main>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bento-card p-8 flex flex-col justify-center text-center bg-amber-700 text-white border-none">
              <div className="text-3xl mb-4">📜</div>
      ...
      <section className="py-24 px-6 bg-zinc-950 text-white rounded-[4rem] mx-4 my-8">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bento-card p-10 bg-zinc-900 text-white border-none">
            <i className="fas fa-coins text-amber-500 mb-6 text-xl"></i>
