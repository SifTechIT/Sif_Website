          ...
          <div className="mt-12 relative">
            ...
            <div className="sm:hidden">
              <article
                ...
                className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-2xl/10 p-6"
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-gradient-to-br from-emerald-500/80 to-purple-500/80 flex items-center justify-center text-sm font-semibold text-white">
