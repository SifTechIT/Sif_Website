      ...
      <header className="hero-section px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl font-light text-gray-500 max-w-3xl mx-auto leading-relaxed mb-12">
            ...
            Safeguarding what is timeless while reinterpreting it for today’s
            world.
          </p>
      ...
      <section className="py-24 px-6 bg-zinc-900 text-white rounded-[4rem] mx-4 my-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold accent-brick mb-2">25+</div>
            ...
            <div>
              <div className="text-4xl font-bold accent-brick mb-2">100+</div>
              <div className="text-[9px] uppercase tracking-[0.2em] text-zinc-500 leading-relaxed">
                Ancient Manuscripts
                <br />
                Preserved
            ...
            <div>
              <div className="text-4xl font-bold accent-brick mb-2">50+</div>
              <div className="text-[9px] uppercase tracking-[0.2em] text-zinc-500 leading-relaxed">
                Community Workshops
                <br />
                Conducted
            ...
            <div>
              <div className="text-4xl font-bold accent-brick mb-2">5+</div>
              <div className="text-[9px] uppercase tracking-[0.2em] text-zinc-500 leading-relaxed">
                Brick House
                <br />
                Centers Planned
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            ...
            <div className="rounded-[3rem] bg-brick-soft aspect-square flex items-center justify-center text-orange-200 overflow-hidden relative shadow-inner">
              <i className="fas fa-monument text-9xl opacity-20"></i>
              <div className="absolute bottom-10 text-center">
                <p className="text-[10px] uppercase tracking-widest font-bold text-orange-800/40">
                  Preserving Civilizational DNA
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bento-card p-8 flex flex-col justify-center text-center bg-orange-800 text-white border-none">
              <div className="text-3xl mb-4">🧱</div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bento-card p-10 bg-zinc-900 text-white border-none">
            <i className="fas fa-university text-orange-400 mb-6 text-xl"></i>
        ...
        >
          ...
          >
            ...
            <div className="container mx-auto max-w-[800px] px-6 text-center text-white">
              ...
              <div className="flex flex-wrap items-center  opacity-90 justify-center gap-4">
                {s.ctas.map((c) => (
                  <a
                    key={c.label}
                    href={c.href}
