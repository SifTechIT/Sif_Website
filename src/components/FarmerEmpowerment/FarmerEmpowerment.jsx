        ...
        >
          ...
          >
            ...
            <div className="container mx-auto max-w-[800px] px-6 text-center text-white">
              ...
              <h1 className="text-[clamp(3rem,8vw,5rem)] opacity-90 font-extrabold leading-tight tracking-[-0.025em] mb-4">
                {s.title}
              </h1>
              ...
              <div className="flex flex-wrap opacity-90 items-center justify-center gap-4">
                {s.ctas.map((c) => (
                  <a
                    key={c.label}
                    href={c.href}
                    className={`inline-block px-6 py-3 rounded-xl font-semibold text-base transition shadow cursor-pointer ${
                      c.primary
